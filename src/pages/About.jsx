  ...
  return (
    <section className="bg-gray-900 text-white py-16 mt-12">
      ...
      <div className=" mx-auto text-center mb-16">
        ...
        <p className="text-lg text-gray-400 animate__animated animate__fadeIn animate__delay-1s">
          Votre partenaire de confiance dans la construction durable et innovante.
        </p>
      </div>

      {/* Our Mission Section */}
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 px-6">
      ...
      <div className="container mx-auto text-center my-16 px-6 animate__animated animate__fadeIn animate__delay-2s">
        ...
        <p className="text-lg text-gray-400 mb-12">Nous proposons une large gamme de services dans le secteur de la construction.</p>
